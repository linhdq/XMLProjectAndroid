...
public class ListLoXien2Adapter extends RecyclerView.Adapter<ListLoXien2Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (list.size() > position && (model = list.get(position)) != null) {
            ...
            holder.txtNumber.setText(String.format("%02d, %02d", model.getNumber1(), model.getNumber2()));
            holder.txtPoint.setText(String.valueOf(model.getPoint()));
            holder.txtPrice.setText(currencyFormatter.format(model.getPoint() * preferenceUtil.getLoXien2PriceNhan()));
